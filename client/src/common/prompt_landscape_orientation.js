/**
 * Add to any page to enforce landscape orientation if max-width < 750px
 */
const promptLandscapeOrientation = () => {
    if (window.matchMedia("(orientation: portrait)").matches && mobileCheck()) {
...
(()=>{
    document.head.insertAdjacentHTML("beforeend", '<link rel="stylesheet" type="text/css" href="styles/orientation_overlay.css">');
